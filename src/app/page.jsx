...
export default async function Page() {
    ...
    let rekomendasiManga = await getNestedAnimeResponse("recommendations/manga", "entry")
    rekomendasiManga = reproduce(rekomendasiManga, 4)
    ...
    return (
      ...
      <div>
        ...
        <section>
          ...
          <RandomMangaList api={rekomendasiManga}/>
        </section>
      </div>
    </>
  );
